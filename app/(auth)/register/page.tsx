    ...
    <div className="h-screen w-screen flex overflow-hidden bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="shrink-0 flex items-center justify-between px-6 lg:px-8 py-4 border-b border-border/60">
          ...
          <Link href="/" className="hidden sm:inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition-colors">
            <ArrowLeft className="w-3.5 h-3.5" />
            Inicio
          </Link>

          <Link href="/login" className="text-sm text-muted-foreground hover:text-foreground transition-colors ml-auto">
        ...
        <div className="flex-1 flex items-center justify-center px-6 overflow-hidden">
          <div className="w-full max-w-[360px]">
            <h1 className="text-xl font-bold text-foreground tracking-tight">Crea tu cuenta gratis</h1>
            ...
            <p className="mt-4 text-center text-xs text-muted-foreground">
              ...
              <Link href="/terms" className="text-primary/80 hover:text-primary hover:underline underline-offset-4">
                Términos de Servicio
              </Link>{' '}
              y{' '}
              <Link href="/privacy" className="text-primary/80 hover:text-primary hover:underline underline-offset-4">
